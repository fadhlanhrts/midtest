...
public class Gasoline {                 //The class will be called gasoline
    public static void main(String[] args){
        double liter;                   //This variable will be used to count the gasoline required by the driver
        double distance=0.0;            //Declaring the distance of each customer's home, here the initial value is 0
        ...
        System.out.println("\nTotal gasoline required is " + String.format("%.2f", liter) + " liters");
    }
}
